...
const NotFound = () => {
  return (
    <section
      ...
      style={{
        background: 'url(https://wallpapers.com/images/hd/1920x1080-hd-space-l0ht6sfmpgh5al1g.jpg) no-repeat',
        backgroundSize: "cover", backgroundPosition: "center"
      }}
    >
      <div className="not-found mask d-flex justify-content-center align-items-center h-100 gradient-custom-3 mt-5">
